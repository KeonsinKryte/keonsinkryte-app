        ...
        return (
            <nav className="nav navbar navbar-expand-lg fixed-top">
                <div className="container">
                    <article className="nav-brand">
                        <Link to="/" onClick={() => scroll.scrollTo(0)}>
                            <h5>Mauricio Botero Vallejo</h5>
                            <h6>UX Researcher | Designer & Design Strategist</h6>
                        </Link>
                    </article>
