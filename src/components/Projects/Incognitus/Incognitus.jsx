            ...
            <main className="project">
                ...
                <section className="project__met">
                    ...
                    <Met
                        ...
                        met__tittle={"Our Approach"} met__text={["We decided to divide our research in three parts due the complexity of our interaction map.", <br></br>, <br></br>, "Three users, each one with it’s own necessities, problems and pains.", <br></br>, <br></br>, "By now, we are going to start talking about Parkinson’s, what it means for patient, what’s the role of a specialist, be clear of the limits, pains, opportunities and frustrations."]}
                    ></Met>
                </section>
                <Discover
                    ...
                    discover__text_why={["For doctors, time is the most important variable. A little bit late and there’s no much you can do.", <br></br>, <br></br>, "For patients, it’s quite important to understand what’s happening in their body, understanding the complexity of a disease and giving solutions that can improve lightly (Due Parkinson’s it’s a catastrophic illness) their life quality."]}
                    discover__text_where={["To give you some context, we’re working with a group of doctors, engineers, designers and a Patient support group called", <strong><a href="https://www.facebook.com/alianzaparkinsoncali/" target="blank">“Alianza Parkinson Cali”</a></strong>, ".", <br></br>, <br></br>, "Together, we’re trying to give solutions to the everyday life problems and tasks of a Parkinson’s patients and create solutions to fast and easily evaluate the progression of the illness."]}
                ></Discover>
                <Define
                ...
                <section className="project__insights">
                    <div className="col-12 project__define-list">
                        ...
                        <ProjectList
                            ...
                            list__text={["The tests works, the questions are the necessary to get the correct information.", <br></br>, "The problem is the form factor, it is hard to understand and pretty slow to apply."]}
                        ></ProjectList>
                        <ProjectList
                            list__emoji={"🧮"} list__emoji_arialabel={"Math"}
                            list__tittle={"It’s 21st century!"} list__number={"3"}
                            list__text={["Why doctors needs to calculate each test?", <br></br>, "Well, you can think it’s just an addition…but there is 75+ questions, different evaluation formats as well as different outcomes to analyze."]}
                        ></ProjectList>
                        <ProjectList
                ...
                <ProjectShowcase
                    ...
                    showcase__tittle_a={"Cognitive tests"} showcase__text_a={"These “mini-games” are pretty important to evaluate and analyze tremor, dyskinesias, short-term memory, language and math solving tasks. This information it’s important and gives the specialist clues about the disease and the performance of the patient."}
                ...
                <Learn
                    ...
                    learn__text={["It’s pretty powerful the feeling that Parkinson’s patients transmit. People that are trying their best to fight against something that every single day it’s worst or the same, but never better.", <br></br>, <br></br>, "This process it’s not creating an app or giving a product. It’s understanding the limits, we cannot solve some things, but we can create tools for people, tools for doctors, provide elements that helps to simplify tasks and improving care.", <br></br>, <br></br>, <h2>Let me tell you about <a href="https://www.icesi.edu.co/i2t/teleco/" target="blank"><br /><span role="img" aria-label="Gear" style={{ color: "#ffa50a" }}>i2t Research Group ⚙️</span></a></h2>, <br></br>, "Specially what we do.", <br></br>, <br></br>, "i2t aims to contribute to global development through the implementation and participation in research and technological development in the field of information and communications technologies.", <br></br>, <br></br>, "The challenges of a research and innovation in e-health are enormous because the definitions and the opportunities are quickly evolving, the use of technology as a tool for health care does not match its original purpose. In addition, their identification with health programs is not well known and the evidence on e-Health is new and is very limited in developing countries.", <br></br>, <br></br>, "i2t has worked in research projects like:", <strong><a href="https://www.icesi.edu.co/i2t/teleco/index.php/grupo-biomedica/44-uncategorised/73-e-motion-capture-system" target="blank"> e-Motion app project, </a></strong>, <strong><a href="https://www.icesi.edu.co/i2t/teleco/index.php/grupo-biomedica/44-uncategorised/74-pdaily" target="blank">PDaily app project, </a></strong>, <strong><a href="https://cnnespanol.cnn.com/2014/10/03/spectra-app-chikunguna/" target="blank">Spectra, </a></strong>, "and among others."]}
                ></Learn>
                <ProjectFarewell
