            ...
            <main className="project">
                ...
                <section className="project__met">
                    <Met
                        ...
                        met__tittle={"Our Challenge"} met__text={["Create a digital solution that satisfy language engagement/learning and digital literacy in kids between 9 - 12.", <br></br>, <br></br>, "The product is going to be used in a rural environment with limited resources (No internet access and toaster technology)."]}
                    ></Met>
                    <Met
                ...
                <Discover
                    ...
                    discover__text_why={["Colombia is one of the most cultural diverse countries, for that reason the preservation of a language it’s a really important task for us.", <br></br>, <br></br>, "The community itself recognize the low engagement showed by its students to learn Nasa Yuwe.", <br></br>, <br></br>, "The oral tradition in this little towns and communities it’s pretty important, specially if we’re talking about the firsts steps in education in a rural context."]}
                    discover__text_where={["There’s no better way to understand the people you’re designing for than by immersing yourself into their lives and communities.", <br></br>, <br></br>, "To give you some context, it’s 2017, one year after", <strong><a href="https://www.nytimes.com/2016/09/27/world/americas/colombia-farc-peace-agreement.html" target="blank">the final agreement to end the armed conflict in Colombia.</a></strong>, <br></br>, <br></br>, "Cauca is one of the most affected regions by this conflict. Over 40 years of resistance by the Nasa community in its territories have delayed this communities to access new technologies and literacy tools."]}
                ></Discover>
                <Define
                ...
                <section className="project__insights">
                    <div className="col-12 project__define-list">
                        ...
                        <ProjectList
                            ...
                            list__text={["This is the core of the project. It’s very important that kids can improve organically from the bottom; learning and practicing the Nasa Yuwe language foundations (Food, colors and animals) and easily jump to complex interactions (Recognizing roles and social hierarchy)."]}
                        ></ProjectList>
                        <ProjectList
                            list__emoji={"👩‍🏫"} list__emoji_arialabel={"Teacher"}
                            list__tittle={"The teacher as a guide for the student"} list__number={"3"}
                            list__text={["The focal point, the most reliable interaction; master and pupil. Here the student has a familiar experience, being guide by someone who really knows who you are.", <br></br>, "This is a powerful metaphor, connect the digital world with the kids reality itself. It’s really gorgeous see how the kids look at his teacher in a tiny computer, they smile, they laugh, they enjoy interact with something familiar, something that really exists."]}
                        ></ProjectList>
                        <ProjectList
                ...
                <ProjectShowcase
                    ...
                    showcase__tittle_a={"The Language"} showcase__text_a={"We decided to create minigames about the core elements we found in the previous stage, such like: Colors, fruits and food, Roles in the community and finally, the foundation myth."}
